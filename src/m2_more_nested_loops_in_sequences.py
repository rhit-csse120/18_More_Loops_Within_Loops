...
def run_test_largest_number():
    ...
    print_expected_result_of_test(
        [[(3, 1, 4), (13, 10, 11, 7, 10), [1, 2, 3, 4]]],
        expected,
        test_results,
        format_string,
    )
    actual = largest_number([(3, 1, 4), (13, 10, 11, 7, 10), [1, 2, 3, 4]])
    print_actual_result_of_test(expected, actual, test_results)

    # Test 2:
    expected = -1111111111111111
    print_expected_result_of_test(
        [([], [-1111111111111111], [])], expected, test_results, format_string
    )
    actual = largest_number(([], [-1111111111111111], []))
    print_actual_result_of_test(expected, actual, test_results)
...
def run_test_largest_negative_number():
    ...
    expected = -2.6
    print_expected_result_of_test(
        [[(30, -5, 8, -20), (100, -2.6, 88, -40, -5), (400, 500)]],
        expected,
        test_results,
        format_string,
    )
    ...
    expected = None
    print_expected_result_of_test(
        [[(200, 2, 20), (500, 400)]], expected, test_results, format_string
    )
    ...
    actual = largest_negative_number(([], [-1111111111111111], []))
    print_actual_result_of_test(expected, actual, test_results)
    ...
    actual = largest_negative_number(
        ((), (), (2, 3, 4, 5, 0, 6, 10), (19, 18, 3, 1), (), (10000000000000000000000,))
    )
    print_actual_result_of_test(expected, actual, test_results)
...
def run_test_first_is_elsewhere_too():
    ...
    expected = True
    print_expected_result_of_test(
        [[(3, 5, 1, 4), (13, 10, 11, 7, 10), [11, 12, 5, 10]]],
        expected,
        test_results,
        format_string,
    )
    ...
    expected = False
    print_expected_result_of_test(
        [[(3, 1, 4), (13, 10, 11, 7, 10), [11, 2, 13, 14]]],
        expected,
        test_results,
        format_string,
    )
    actual = first_is_elsewhere_too([(3, 1, 4), (13, 10, 11, 7, 10), [11, 2, 13, 14]])
    print_actual_result_of_test(expected, actual, test_results)

    # Test 3:
    expected = False
    print_expected_result_of_test(
        [[[], [1, 2], [1, 2]]], expected, test_results, format_string
    )
    ...
    expected = False
    print_expected_result_of_test(
        [(("a", 9), (13, 10, 11, 7, "aa"), [11, 12, 3, 10])],
        expected,
        test_results,
        format_string,
    )
    actual = first_is_elsewhere_too((("a", 9), (13, 10, 11, 7, "999"), [11, 12, 3, 10]))
    print_actual_result_of_test(expected, actual, test_results)

    # Test 6:
    expected = False
    print_expected_result_of_test(
        [[("a", "a", "b", "b", "a", "b")]], expected, test_results, format_string
    )
    ...
    expected = True
    print_expected_result_of_test(
        [[("a",), (), (), (), ("a",), ()]], expected, test_results, format_string
    )
    ...
    expected = False
    print_expected_result_of_test(
        [("a",), (), (), (), ("b",), ()], expected, test_results, format_string
    )
    ...
    expected = True
    print_expected_result_of_test(
        [["hello", "goodbye"]], expected, test_results, format_string
    )
    ...
    expected = False
    print_expected_result_of_test(
        [["hello", "xxxxxxxxxxx"]], expected, test_results, format_string
    )
    ...
    expected = True
    print_expected_result_of_test(
        [["hello", "xxxxxxxx", "this", "is", "a", "test", "o"]],
        expected,
        test_results,
        format_string,
    )
    ...
    expected = True
    print_expected_result_of_test(
        [["hello", "xxxxxxxx", "this", "is", "aoaoaoaoaoaoa", "test", "z"]],
        expected,
        test_results,
        format_string,
    )
    ...
    actual = first_is_elsewhere_too(
        ["hello", "xxxxxxxx", "this", "is", "aaaaaaaaaaaaaa e aaaaaaaaa", "tEst", "z"]
    )
    print_actual_result_of_test(expected, actual, test_results)
    ...
    expected = True
    print_expected_result_of_test(
        [[(1000 * "a") + "b" + (500 * "a"), (800 * "c") + "d" + 1200 * "c", "b"]],
        expected,
        test_results,
        format_string,
    )
    ...
    expected = True
    print_expected_result_of_test(
        [[(1000 * "b") + "acd" + (500 * "f"), (800 * "1") + "234a", "eeee"]],
        expected,
        test_results,
        format_string,
    )
    ...
    expected = True
    print_expected_result_of_test(
        [[(1000 * "b") + "acd" + (500 * "f"), "a" + (800 * "1") + "234", "123"]],
        expected,
        test_results,
        format_string,
    )
    ...
    print_expected_result_of_test(
        [test1 + ["a"] + test2], expected, test_results, format_string
    )
    ...
    expected = False
    print_expected_result_of_test(
        [test1 + test2], expected, test_results, format_string
    )
    ...
    expected = True
    print_expected_result_of_test(
        [test1 + [a_inside] + test2], expected, test_results, format_string
    )
